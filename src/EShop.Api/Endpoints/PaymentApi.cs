...
using EShop.Application.Payment.Commands.CreatePaymentUrl;
using EShop.Application.Payment.Commands.VerifyPaymentIpn;
using EShop.Application.Payment.Commands.VerifyPaymentReturn;
