...
using EShop.Api.Models.Responses;
using EShop.Application.Catalog.Categories.Commands.CreateCategory;
using EShop.Application.Catalog.Categories.Dtos;
using EShop.Application.Catalog.Categories.Queries.GetListCategory;
using EShop.Application.Catalog.Products.Commands.BulkUpdateVariant;
using EShop.Application.Catalog.Products.Commands.CreateOption;
using EShop.Application.Catalog.Products.Commands.CreateOptionValue;
using EShop.Application.Catalog.Products.Commands.CreateProduct;
using EShop.Application.Catalog.Products.Commands.CreateProductImage;
using EShop.Application.Catalog.Products.Commands.CreateVariant;
using EShop.Application.Catalog.Products.Commands.DeleteOption;
using EShop.Application.Catalog.Products.Commands.DeleteProduct;
using EShop.Application.Catalog.Products.Commands.DeleteProductImage;
using EShop.Application.Catalog.Products.Commands.DeleteVariant;
using EShop.Application.Catalog.Products.Commands.GenerateVariant;
using EShop.Application.Catalog.Products.Commands.UpdateProduct;
using EShop.Application.Catalog.Products.Commands.UpdateVariant;
using EShop.Application.Catalog.Products.Queries.GetAvailableProducts;
using EShop.Application.Catalog.Products.Queries.GetListProduct;
using EShop.Application.Catalog.Products.Queries.GetProductById;
using EShop.Application.Catalog.Products.Queries.GetVariantById;
using EShop.Application.Catalog.Products.Queries.GetVariantByOption;
using AutoMapper;
using MediatR;
