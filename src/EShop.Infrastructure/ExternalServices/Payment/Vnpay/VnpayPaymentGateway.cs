...
namespace EShop.Infrastructure.ExternalServices.Payment.Vnpay;

public class VnpayPaymentGateway : IPaymentGateway
{
    private readonly VnpayOptions _vnpOption;
    private readonly ICurrentIPAddress _currentIPAddressProvider;

    public VnpayPaymentGateway(
        IOptions<VnpayOptions> options,
        ICurrentIPAddress currentIPAddressProvider)
    {
